...
| Release-bound environment evidence | fail-closed admission manifest binds customer-staging controls, verifier, UTC freshness and durable evidence URI to an exact 40-character release SHA | positive and missing/pending/wrong-release negative tests plus `admission-verify` non-zero CLI contract |
